...
public class FieldStorage {
    ...
    public static boolean boolean7;
    public static boolean boolean8;
    public static boolean boolean9;
    public static boolean boolean10;
