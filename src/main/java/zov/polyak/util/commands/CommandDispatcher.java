...
import zov.polyak.event.list.ChatEvent;
import zov.polyak.event.list.TabCompleteEvent;
import zov.polyak.util.commands.api.argument.ICommandArgument;
import zov.polyak.util.commands.api.exception.CommandNotEnoughArgumentsException;
import zov.polyak.util.commands.api.exception.CommandNotFoundException;
import zov.polyak.util.commands.api.helpers.TabCompleteHelper;
import zov.polyak.util.commands.api.manager.ICommandManager;
import zov.polyak.util.commands.argument.ArgConsumer;
import zov.polyak.util.commands.argument.CommandArguments;
import zov.polyak.util.commands.manager.CommandRepository;

import java.util.List;
import java.util.stream.Stream;

import static zov.polyak.util.commands.api.IBaritoneChatControl.FORCE_COMMAND_PREFIX;
...
public class CommandDispatcher {
    ...
    public CommandDispatcher() {
        this.manager = Polyak.getInstance().getCommandRepository();
