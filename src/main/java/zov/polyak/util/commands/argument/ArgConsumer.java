...
package zov.polyak.util.commands.argument;

import zov.polyak.util.commands.api.argument.IArgConsumer;
import zov.polyak.util.commands.api.argument.ICommandArgument;
import zov.polyak.util.commands.api.datatypes.IDatatype;
import zov.polyak.util.commands.api.datatypes.IDatatypeContext;
import zov.polyak.util.commands.api.datatypes.IDatatypeFor;
import zov.polyak.util.commands.api.datatypes.IDatatypePost;
...
import zov.polyak.util.commands.api.exception.CommandTooManyArgumentsException;
