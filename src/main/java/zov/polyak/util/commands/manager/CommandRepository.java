package zov.polyak.util.commands.manager;
...
import zov.polyak.util.commands.api.exception.CommandUnhandledException;
import zov.polyak.util.commands.api.exception.ICommandException;
...
import zov.polyak.util.commands.defaults.DefaultCommands;
    ...
    public Stream<String> tabComplete(String prefix) {
        ...
        if (args.isEmpty()) {
            return new TabCompleteHelper()
                    .addCommands(Polyak.getInstance().getCommandRepository())
                    .filterPrefix(label)
                    .stream();
        } else {
