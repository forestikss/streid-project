...
import zov.polyak.module.list.combat.AntiBot;
...
import zov.polyak.util.render.lines.VertexUtil;
...
public class Tracers extends Module {
    ...
    private boolean isValid(Entity entity) {
        ...
        if (entity instanceof PlayerEntity p) {
            if (Polyak.getInstance().getModuleStorage().get(AntiBot.class).isBot(p)) return false;
