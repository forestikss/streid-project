...
public class ThemeManagerWindow implements IMinecraft {
    ...
    private static final File THEME_DIR = new File("polyakzov");
    ...
    static final String[] COLOR_NAMES = {
        ...
        "Текст в подсказках", "Фон окон", "Цвет иконок", "Цвет клиента"
    };
    ...
    private void applyColors() {
        zov.polyak.module.settings.impl.Theme t =
            zov.polyak.module.settings.impl.ThemeManager.getInstance().getCurrentTheme();
        int[] c = currentColors;
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        DrawUtil.drawText(Fonts.SFREGULAR.get(), displayName, fieldX+4f, fixedY+4f, nameColor, 7f);
        fixedY += FIELD_H + 2f;
        ...
        float btnTextW = Fonts.SFREGULAR.get().getWidth(btnText, 7f);
        DrawUtil.drawText(Fonts.SFREGULAR.get(), btnText,
            fieldX + fieldW/2f - btnTextW/2f, fixedY+4f,
    ...
    private void renderRow(int slot, float rx, float ry, float rw,
